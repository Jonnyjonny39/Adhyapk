package com.jonnyjonny.s_assistant.main.components;
...
import com.jonnyjonny.s_assistant.BatchNoteActivity;
import com.jonnyjonny.s_assistant.R;
import com.jonnyjonny.s_assistant.main.AppBase;
import com.jonnyjonny.s_assistant.main.attendance.AttendanceActivity;
import com.jonnyjonny.s_assistant.main.notes.NoteActivity;
import com.jonnyjonny.s_assistant.main.profile.ProfileActivity;
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        } else if (names.get(position).toString().equals(" TEST SCHEDULER")) {
        ...
        } else if (names.get(position).toString().equals("BATCHES")) {
            imageView.setImageResource(R.drawable.ic_notes);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity, BatchNoteActivity.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
